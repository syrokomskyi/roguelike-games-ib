...
This file is hand-maintained. Edit freely to add, update, or correct project rules.
...
Always use well-maintained npm packages instead of writing custom implementations. Do not reinvent the wheel — if a package solves the problem, use it. This applies to visualization (D3.js), parsing, formatting, search, and all other domains. The project has no restrictions on adding npm dependencies that improve the codebase.
