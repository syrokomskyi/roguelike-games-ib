/*
<MODULE_CONTRACT>
<purpose>Curated mapping of game design sensations to relevant concept keys for the Laboratory page (RFC-0013). Duplicate of apps/mcp/src/tools/sensation-map.ts — no shared package exists between apps/mcp and apps/web.</purpose>
<non-goals>
  <item>Does not perform concept lookup — only stores the mapping.</item>
  <item>Does not handle fallback for unknown sensations — that is laboratory.ts's responsibility.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
