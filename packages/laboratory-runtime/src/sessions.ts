/*
<MODULE_CONTRACT>
<purpose>Creates, persists, reads, and updates inspiration sessions tracking constraints and associated seed IDs.</purpose>
<non-goals>
  <item>Does not create seeds — session lifecycle only.</item>
</non-goals>
</MODULE_CONTRACT>
<CHANGE_SUMMARY>
  <item>Initial creation: InspirationSession type, createSession, persistSession, readSession, addSeedToSession.</item>
</CHANGE_SUMMARY>
*/
